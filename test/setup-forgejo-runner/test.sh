...
# includes the 'setup-forgejo-runner' Feature with no options.
#
...
# For the 'setup-forgejo-runner' feature, that means the default version is 'latest'.
#
...
#               --features setup-forgejo-runner          \
#               --remote-user root                       \
#               --skip-scenarios                         \
#               --base-image ghcr.io/sebatec-eu/base-devcontainer:1 \
#               /path/to/this/repo
