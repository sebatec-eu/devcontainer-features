...
# includes the 'setup-forgejo-runner:2' feature with 'setup-podman' and apt packages.
...
check "apt-packages installed: bash-completion" apt-cache search bash-completion | grep -q bash-completion
check "apt-packages installed: pwgen" which pwgen
