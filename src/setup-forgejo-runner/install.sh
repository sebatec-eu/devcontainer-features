...
#!/bin/bash
exec forgejo-runner exec --container-daemon-socket /tmp/podman-143d1b19-36fb-4790-9a48-eb7a5e5e378e.sock --image=ghcr.io/sebatec-eu/stable-forgejo-runner:1 "\$@"
EOF
